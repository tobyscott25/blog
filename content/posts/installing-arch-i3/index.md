...
The official Arch repo is great, but it doesn't have everything... So we have the _Arch User Repository (AUR)_ which is a community-driven repository for Arch users.
